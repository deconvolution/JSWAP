...
"
function JSWAP_CPU_3D_forward_tri_solver(input2)
    #global data
    global data
    ...
    for l=1:input2.nt-1
        ...
        @timeit ti "compute_v" @parallel JSWAP_CPU_3D_tri_forward_solver_compute_v(input2.dt,input2.dx,input2.dy,input2.dz,
        input2.rho,beta,
        v1,v2,v3,
        sigmas11_1_minus,
        sigmas22_2_minus,
