function inversion_procedure(input2,
    path_to_input)
    ...
    for l=1:n_iteration
        ...
        vtkfile=vtk_grid(string("./inversion_progress/v_",l),input2.X,
        input2.Y,input2.Z);
        vtkfile["v"]=input2.v;
        vtkfile["DV"]=DV;
        vtk_save(vtkfile);
