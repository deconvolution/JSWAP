...
@doc "`@maxloc(A)`: Compute the maximum between 2nd order adjacent elements of `A`, using a moving window of size 3." :(@maxloc)
@doc "`@minloc(A)`: Compute the minimum between 2nd order adjacent elements of `A`, using a moving window of size 3." :(@minloc)
@doc "`@d_xi_8`: Compute first-order derivative with 8 points in the x-direction." :(@d_xi_8)
@doc "`@d_yi_8`: Compute first-order derivative with 8 points in the y-direction." :(@d_yi_8)
@doc "`@d_zi_8`: Compute first-order derivative with 8 points in the z-direction." :(@d_zi_8)
@doc "`@d_xi_12`: Compute first-order derivative with 12 points in the x-direction." :(@d_xi_12)
@doc "`@d_yi_12`: Compute first-order derivative with 12 points in the y-direction." :(@d_yi_12)
@doc "`@d_zi_12`: Compute first-order derivative with 12 points in the z-direction." :(@d_zi_12)
...
#=
ix=Symbol("##ix, Main.ParallelStencil#267");
iy=Symbol("##iy, Main.ParallelStencil#268");
iz=Symbol("##iy, Main.ParallelStencil#269");
=#
