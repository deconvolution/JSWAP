...
input2.M11[:]=rickerWave(1,input2.dt,input2.nt,2)*1.0;
input2.M22[:]=rickerWave(1,input2.dt,input2.nt,2)*1.0;
input2.M33[:]=rickerWave(1,input2.dt,input2.nt,2)*1.0;
