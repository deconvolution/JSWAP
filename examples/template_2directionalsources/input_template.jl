...
input2.s3[:] =[49 52];
# source signal x
input2.src1=zeros(input2.nt,2);
# source signal y
input2.src2=zeros(input2.nt,2);
# source signal z
input2.src3=repeat(reshape(rickerWave(20,10^-3*1.0,1000,2),input2.nt,1),1,2);
# source signal pressure
input2.srcp=zeros(input2.nt,2);
